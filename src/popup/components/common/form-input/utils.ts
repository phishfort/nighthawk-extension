export const CUSTOM_ERROR_MSG = {
	...
	WHITE_LIST_ERROR_MSG: 'Sorry, the URL you are trying to add is marked as safe by Nighthawk.',
...
export const getCustomErrorMsg = ({
	...
	switch (true) {
		...
		case isWhiteListError:
			return CUSTOM_ERROR_MSG.WHITE_LIST_ERROR_MSG;
		default:
			return '';
	}
};
